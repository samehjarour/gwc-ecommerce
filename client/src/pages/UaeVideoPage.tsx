...
export function UaeVideoPage() {
  useEffect(() => {
    document.title = "Reliable E-commerce Fulfillment in UAE with Real Customer Service | GWC";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Get reliable e-commerce fulfillment in UAE with real customer service that is there when you need it. 99% on-time delivery with responsive local support.');
    }
  }, []);
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative py-20 bg-gradient-to-b from-background to-muted/20 overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <Badge variant="outline" className="mb-4" data-testid="badge-uae-leader">
                  UAE&apos;s #1 E-commerce Fulfillment Partner
                </Badge>
                <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="heading-hero">
                  Get reliable e-commerce fulfillment in UAE with <em className="italic text-primary not-italic">real customer service</em> that&apos;s there when you need it
                </h1>
                <p className="text-xl text-muted-foreground mb-8" data-testid="text-hero-description">
                  Experience dependable delivery with 99% on-time performance and responsive support team that actually answers.
                </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center hover-elevate" data-testid="card-delivery">
                <CardContent className="pt-8 pb-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    99% on-time delivery rate in UAE. Your customers get their orders when promised, building trust in your brand.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover-elevate" data-testid="card-support">
                <CardContent className="pt-8 pb-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Responsive support from our local UAE team. Get answers when you need them, not days later.
                  </p>
                </CardContent>
              </Card>
        ...
        {/* Testimonials */}
        <TestimonialsSection segment="uae-video" />
              ...
              <div>
                <div className="space-y-6">
                  <div className="flex items-start gap-4" data-testid="step-connect">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Quick integration with your e-commerce platform. Our UAE team guides you through setup.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4" data-testid="step-inventory">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">Send Inventory to UAE</h3>
                      <p className="text-muted-foreground">
                        Ship products to our UAE fulfillment centers for fast local delivery across the Emirates.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4" data-testid="step-support">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Local UAE support team available to help you and answer customer questions quickly.
                      </p>
                    </div>
                  </div>
                </div>
