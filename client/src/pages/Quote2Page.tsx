...
export function Quote2Page() {
  const [currentStep, setCurrentStep] = useState<Step>(1);
  const [formData, setFormData] = useState({
    shipFrom: ["Qatar", "UAE"], // Pre-filled for these landing pages
    shipTo: ["GCC"], // Pre-filled
    platforms: [] as string[],
    products: [] as string[],
    firstName: "",
    lastName: "",
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-2xl">
                  {currentStep === 1 && "Platform & Products"}
                    ...
                    <div className="space-y-6" data-testid="step-contact">
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          placeholder="Tell us more about your fulfillment needs..."
                          rows={4}
