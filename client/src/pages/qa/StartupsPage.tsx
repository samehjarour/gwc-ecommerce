            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  Start Your <span className="text-primary">Qatar E-Commerce</span> Journey Today
                </h1>
                ...
                <div className="mt-8 flex gap-8">
                  ...
                  <div>
                    <div className="text-2xl font-bold">QAR 0</div>
                    <div className="text-sm text-muted-foreground">Minimum Order</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">24hrs</div>
                    <div className="text-sm text-muted-foreground">Delivery in Qatar</div>
                  </div>
                </div>
              </motion.div>
