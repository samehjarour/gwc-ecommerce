...
import { GWCRateCalculatorQatarV2 } from "@/components/GWCRateCalculatorQatarV2";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent } from "@/components/ui/card";
import { Calculator, TrendingDown, Shield, Zap } from "lucide-react";
import { useEffect } from "react";

export function QARateCalculatorPage() {
  useEffect(() => {
    document.title = "Qatar Fulfillment Cost Calculator - Transparent Pricing | GWC with Quivo";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Calculate your exact fulfillment costs in Qatar. Transparent pricing for warehousing, fulfillment, shipping, and returns. No hidden fees.');
    }
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Qatar Fulfillment <span className="text-primary">Cost Calculator</span>
              </h1>
