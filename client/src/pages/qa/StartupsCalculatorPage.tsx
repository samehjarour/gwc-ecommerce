                  ...
                  <div className="text-center" data-testid="content-deliver">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-8">
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-6 h-6 text-primary mt-1" />
                        <div>
                          <strong>Same-day delivery:</strong> Available across Doha, Abu Dhabi, and major Qatar cities.
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle className="w-6 h-6 text-primary mt-1" />
            ...
            >
              ...
              <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Traditional 3PLs charge QAR 500-2,000+ per month for these services. We include them.
                  </p>
