...
export function IntegrationsSectionAr() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-20">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-semibold mb-6" data-testid="text-partnership-badge">
              مدعوم من تكامل Quivo
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6" data-testid="text-partnership-title">
              حلول عالمية مدعومة بشراكة Quivo
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              تقنيات ومنصات تنفيذ متقدمة مصممة لمتطلبات عملك من خلال تحالفنا الاستراتيجي مع <a href="https://quivo.co/us/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-semibold">Quivo</a>.
            </p>
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center p-6">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">تكامل بنقرة واحدة</h3>
                <p className="text-muted-foreground">اربط متجرك في دقائق مع عملية الإعداد السلسة لدينا</p>
              </div>
              <div className="text-center p-6">
                <div className="w-16 h-16 mx-auto mb-4 bg-primary/10 rounded-full flex items-center justify-center">
                  <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">مزامنة فورية</h3>
                <p className="text-muted-foreground">إدارة تلقائية للمخزون والطلبات عبر جميع القنوات</p>
              </div>
              <div className="text-center p-6">
                <div className="w-16 h-16 mx-auto mb-4 bg-primary/10 rounded-full flex items-center justify-center">
                  <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">توسع سلس</h3>
                <p className="text-muted-foreground">انمو من شركة ناشئة إلى مؤسسة مع بنيتنا التحتية المرنة</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4" data-testid="text-integrations-title">
            الوصول إلى مجموعة متنوعة من تكاملات التجارة الإلكترونية الجاهزة
          </h3>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-12">
            اتصل بأكثر من 40 منصة وسوق مدعومة
          </p>
        </div>
