...
const testimonials: TestimonialData[] = [
  {
    quote: "الشراكة مع جي دبليو سي سهلت سلسلة التوريد الإقليمية لدينا. مستودعاتهم القابلة للتطوير وفريقهم الاستباقي يضمنان عمليات سلسة وتسليمات في الوقت المحدد، مما يجعلهم شريكاً لوجستياً موثوقاً.",
  ...
  {
    quote: "مع إدارة جي دبليو سي للبنية التحتية اللوجستية لدينا، شهدنا سلاسل توريد أكثر سلاسة وكفاءة تشغيلية أكبر. خبرتهم تسمح لنا بالتركيز على ما نقوم به بشكل أفضل - خلق حياة يومية أفضل لعملائنا.",
    company: "IKEA",
    logo: "I"
  }
];
