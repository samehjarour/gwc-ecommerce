...
export function MapStatsSection() {
  ...
  const mapDots = Array.from({ length: 180 }, (_, i) => ({
    ...
    y: Math.random() * 100,
    delay: Math.random() * 2,
    isHighlight: Math.random() > 0.92, // 8% chance for colored dots
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-12 text-center relative z-10">
          ...
          >
            ...
            <div className="text-lg uppercase tracking-wider">International Clients</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-lg uppercase tracking-wider">Warehouses Worldwide</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-lg uppercase tracking-wider">Employees</div>
          </motion.div>
        </div>
      </div>
    </section>
